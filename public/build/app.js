...
var PlayerList = React.createClass({displayName: "PlayerList",
    render: function() {
        var playerNodes = this.props.data.map(function(player, index){
            return (
                React.createElement(Player, {avatar: player.avatar, name: player.name, platform: player.platform, players: player.players, slogan: player.slogan})
            );
        });
        return (
            React.createElement("div", null, 
                React.createElement("ul", {id: "tabs"}, 
                    React.createElement("li", {className: "current"}, "招募榜"), 
                    React.createElement("li", null, "活跃榜")
                ), 
                React.createElement("div", {id: "playerList"}, 
                    React.createElement("div", {id: "info"}, "正在招募成员的公会，按发布招募时间排名"), 
                    playerNodes
                )
            )
        )
        ...
        return (
            React.createElement("div", {id: "content"}, 
                React.createElement("div", {id: "searchContainer"}, 
                    React.createElement("div", {id: "searchContent"}, 
                        React.createElement("span", {id: "search"}, "请输入公会ID")
                    )
                ), 
                React.createElement("div", {id: "banner"}), 
                React.createElement("h3", null, 
                    "已有", React.createElement("em", null, this.state.num), "个公会入驻，累计", React.createElement("em", null, this.state.player), "位玩家"
                ), 
                React.createElement("div", {id: "statusImg"}, 
                    React.createElement("button", {id: "joinBtn"}), 
                    React.createElement("button", {id: "createBtn"})
                ), 
...
React.render(
    React.createElement(Page, {url: "playerList.json"}),
    document.getElementById('container')
);

},{"jquery":1,"react":156}],158:[function(require,module,exports){
